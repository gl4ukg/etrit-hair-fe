  ...
  return (
    ...
    >
      {reviews.map((review) => (
        ...
        >
          <article className="relative flex h-full flex-col justify-between overflow-hidden rounded-2xl border border-zinc-800/60 bg-zinc-900/70 p-5 text-sm text-zinc-200 shadow-[0_18px_60px_rgba(0,0,0,0.65)]">
